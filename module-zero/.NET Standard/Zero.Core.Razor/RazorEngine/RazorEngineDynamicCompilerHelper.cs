...
{
    public class RazorEngineDynamicCompilerHelper
    {
        private const string dynamicAssemblyNamespace = "TemplateDynamicAssembly";
        private const string dynamicDllName = "TemplateDynamicAssemblyDll";

        public static Assembly CompileTemplate(string razorTemplateFileName)
        {
        ...
        private static RazorProjectItem GetRazorProjectItem(RazorProjectFileSystem razorProjectFileSystem, string razorTemplateFileName)
        {
            ...
            return razorProjectFileSystem.GetItem(path: $"{razorTemplateFileName}");
        }
